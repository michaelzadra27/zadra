    ...
    return (
        <div className="row" >
            ...
            <div className="col-6">
                ...
                <h4>I've built this site to house some of my projects that I've worked on over the past year. I got into Web Development because the idea of creating applications from scratch has always intrigued me. I graudated Chico State with a degree in Business Marketing and have spent the majority of my career in the tech world. Thank you for visiting my page!</h4>
            </div>
            <div className="col-1">
            </div>
        </div>
